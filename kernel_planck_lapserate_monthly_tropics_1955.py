...
for k in range(len(filenames2a)):
    ...
    print('Annual Tropics planck feedback: ' + np.str(planck_feedback[k]) + ' W m^-2 K^-1')
    print('Annual Tropics lapse rate feedback: ' + np.str(lapserate_feedback[k]) + ' W m^-2 K^-1')
    
    print('Monthly Tropics planck feedback: ' + np.str(np.round(planck_feedback_mon[k], 3)) + ' W m^-2 K^-1')
    print('Monthly Tropics lapse rate feedback: ' + np.str(np.round(lapserate_feedback_mon[k], 3)) + ' W m^-2 K^-1')
    
outfile = open('Tropics_Planck_Feedback_1955', 'wb')
pickle.dump(planck_feedback, outfile)
outfile.close()

outfile = open('Tropics_Lapse_Rate_Feedback_1955', 'wb')
pickle.dump(lapserate_feedback, outfile)
outfile.close()

outfile = open('Tropics_Planck_Feedback_Monthly_1955', 'wb')
pickle.dump(planck_feedback_mon, outfile)
outfile.close()

outfile = open('Tropics_Lapse_Rate_Feedback_Monthly_1955', 'wb')
pickle.dump(lapserate_feedback_mon, outfile)
outfile.close()

outfile = open('Tropics_Planck_Feedback_Flux_1955', 'wb')
pickle.dump(planck_feedback_flux, outfile)
outfile.close()

outfile = open('Tropics_Lapse_Rate_Feedback_Flux_1955', 'wb')
pickle.dump(lapserate_feedback_flux, outfile)
outfile.close()

outfile = open('Tropics_Planck_Feedback_Flux_Monthly_1955', 'wb')
pickle.dump(planck_feedback_flux_mon, outfile)
outfile.close()

outfile = open('Tropics_Lapse_Rate_Feedback_Flux_Monthly_1955', 'wb')
pickle.dump(lapserate_feedback_flux_mon, outfile)
outfile.close()

np.savetxt('Tropics_Planck_Feedback_Monthly_1955.csv', planck_feedback, delimiter = ',')
np.savetxt('Tropics_Lapse_Rate_Feedback_Monthly_1955.csv', lapserate_feedback, delimiter = ',')

np.savetxt('Tropics_Planck_Feedback_Monthly_1955.csv', planck_feedback_mon, delimiter = ',')
np.savetxt('Tropics_Lapse_Rate_Feedback_Monthly_1955.csv', lapserate_feedback_mon, delimiter = ',')

np.savetxt('Tropics_Planck_Feedback_Flux_1955.csv', planck_feedback_flux, delimiter = ',')
np.savetxt('Tropics_Lapse_Rate_Feedback_Flux_1955.csv', lapserate_feedback_flux, delimiter = ',')

np.savetxt('Tropics_Planck_Feedback_Flux_Monthly_1955.csv', planck_feedback_flux_mon, delimiter = ',')
np.savetxt('Tropics_Lapse_Rate_Feedback_Flux_Monthly_1955.csv', lapserate_feedback_flux_mon, delimiter = ',')
