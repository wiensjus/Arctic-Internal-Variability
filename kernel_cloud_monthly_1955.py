...
ds_ghg = [ds10, ds11, ds12, ds13, ds14, ds15, ds16, ds17, ds18, ds19, ds20, ds21]
...
for k in range(len(data1)):
    ...
    #print(np.nanmean(np.nanmean(np.nanmean(np.nanmean(qs1, 3), 2), 1), 0))
    #print(np.nanmean(np.nanmean(np.nanmean(np.nanmean(qs2, 3), 2), 1), 0))
    #print(np.nanmean(np.nanmean(np.nanmean(np.nanmean(dqsdt, 3), 2), 1), 0))
    #print(np.nanmean(np.nanmean(np.nanmean(np.nanmean(rh, 3), 2), 1), 0))
    #print(np.nanmean(np.nanmean(np.nanmean(np.nanmean(dqdt, 3), 2), 1), 0))
    ...
    dLW_cloud_globalmean = np.nansum(np.nansum(np.nanmean(-dLW_cloud, 2) * weight, 1), 0)
    dLW_cloud_globalmean_mon = np.nansum(np.nansum(-dLW_cloud * weight_mon, 1), 0)
    
    dSW_cloud_globalmean = np.nansum(np.nansum(np.nanmean(dSW_cloud, 2) * weight, 1), 0)
...
outfile = open('LW_Cloud_Feedback_1955', 'wb')
pickle.dump(LWc_feedback, outfile)
outfile.close()

outfile = open('LW_Cloud_Feedback_Monthly_1955', 'wb')
pickle.dump(LWc_feedback_mon, outfile)
outfile.close()

outfile = open('LW_Cloud_Feedback_Flux_1955', 'wb')
pickle.dump(LWc_feedback_flux, outfile)
outfile.close()

outfile = open('LW_Cloud_Feedback_Flux_Monthly_1955', 'wb')
pickle.dump(LWc_feedback_flux_mon, outfile)
outfile.close()

outfile = open('SW_Cloud_Feedback_1955', 'wb')
pickle.dump(SWc_feedback, outfile)
outfile.close()

outfile = open('SW_Cloud_Feedback_Monthly_1955', 'wb')
pickle.dump(SWc_feedback_mon, outfile)
outfile.close()

outfile = open('SW_Cloud_Feedback_Flux_1955', 'wb')
pickle.dump(SWc_feedback_flux, outfile)
outfile.close()

outfile = open('SW_Cloud_Feedback_Flux_Monthly_1955', 'wb')
pickle.dump(SWc_feedback_flux_mon, outfile)
outfile.close()

np.savetxt('LW_Cloud_Feedback_1955.csv', LWc_feedback, delimiter = ',')
np.savetxt('LW_Cloud_Feedback_Monthly_1955.csv', LWc_feedback_mon, delimiter = ',')

np.savetxt('LW_Cloud_Feedback_Flux_1955.csv', LWc_feedback_flux, delimiter = ',')
np.savetxt('LW_Cloud_Feedback_Flux_Monthly_1955.csv', LWc_feedback_flux_mon, delimiter = ',')

np.savetxt('SW_Cloud_Feedback_1955.csv', SWc_feedback, delimiter = ',')
np.savetxt('SW_Cloud_Feedback_Monthly_1955.csv', SWc_feedback_mon, delimiter = ',')

np.savetxt('SW_Cloud_Feedback_Flux_1955.csv', SWc_feedback_flux, delimiter = ',')
np.savetxt('SW_Cloud_Feedback_Flux_Monthly_1955.csv', SWc_feedback_flux_mon, delimiter = ',')
