...
infile = open('Albedo_Feedback_Flux_1955', 'rb')
alb_feedback_flux = np.array(pickle.load(infile))
infile.close()

infile = open('Albedo_Feedback_Flux_Monthly_1955', 'rb')
alb_feedback_flux_mon = np.array(pickle.load(infile))
infile.close()

infile = open('Arctic_Albedo_Feedback_Flux_1955', 'rb')
alb_feedback_arc_flux = np.array(pickle.load(infile))
infile.close()

infile = open('Arctic_Albedo_Feedback_Flux_Monthly_1955', 'rb')
alb_feedback_arc_flux_mon = np.array(pickle.load(infile))
infile.close()

infile = open('Tropics_Albedo_Feedback_Flux_1955', 'rb')
alb_feedback_trop_flux = np.array(pickle.load(infile))
infile.close()

infile = open('Tropics_Albedo_Feedback_Flux_Monthly_1955', 'rb')
...
for i in range(len(filenames1a)):
    ...
    print(alb_feedback_arc_flux[i], planck_feedback[i])
    ...
    alb_warming_trop_mon.append(temp1arc)
    temp1 = []
    temp1arc = []
    temp1trop = []
    #print(alb_warming[i])
    
outfile = open('Albedo_Feedback_Warming_1955', 'wb')
pickle.dump(alb_warming, outfile)
outfile.close()

outfile = open('Albedo_Feedback_Warming_Monthly_1955', 'wb')
pickle.dump(alb_warming_mon, outfile)
outfile.close()

outfile = open('Arctic_Albedo_Feedback_Warming_1955', 'wb')
pickle.dump(alb_warming_arc, outfile)
outfile.close()

outfile = open('Arctic_Albedo_Feedback_Warming_Monthly_1955', 'wb')
pickle.dump(alb_warming_arc_mon, outfile)
outfile.close()

outfile = open('Tropics_Albedo_Feedback_Warming_1955', 'wb')
pickle.dump(alb_warming_trop, outfile)
outfile.close()

outfile = open('Tropics_Albedo_Feedback_Warming_Monthly_1955', 'wb')
pickle.dump(alb_warming_trop_mon, outfile)
outfile.close()

np.savetxt('Albedo_Feedback_Warming_1955.csv', alb_warming, delimiter = ',')
np.savetxt('Albedo_Feedback_Warming_Monthly_1955.csv', alb_warming_mon, delimiter = ',')

np.savetxt('Arctic_Albedo_Feedback_Warming_1955.csv', alb_warming_arc, delimiter = ',')
np.savetxt('Arctic_Albedo_Feedback_Warming_Monthly_1955.csv', alb_warming_arc_mon, delimiter = ',')

np.savetxt('Tropics_Albedo_Feedback_Warming_1955.csv', alb_warming_trop, delimiter = ',')
np.savetxt('Tropics_Albedo_Feedback_Warming_Monthly_1955.csv', alb_warming_trop_mon, delimiter = ',')

print(alb_warming_arc)
print(np.mean(alb_warming_arc))
