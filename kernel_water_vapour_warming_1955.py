...
infile = open('Water_Vapour_Feedback_Flux_1955', 'rb')
alb_feedback_flux = np.array(pickle.load(infile))
infile.close()

infile = open('Water_Vapour_Feedback_Flux_Monthly_1955', 'rb')
alb_feedback_flux_mon = np.array(pickle.load(infile))
infile.close()

infile = open('Arctic_Water_Vapour_Feedback_Flux_1955', 'rb')
alb_feedback_arc_flux = np.array(pickle.load(infile))
infile.close()

infile = open('Arctic_Water_Vapour_Feedback_Flux_Monthly_1955', 'rb')
alb_feedback_arc_flux_mon = np.array(pickle.load(infile))
infile.close()

infile = open('Tropics_Water_Vapour_Feedback_Flux_1955', 'rb')
alb_feedback_trop_flux = np.array(pickle.load(infile))
infile.close()

infile = open('Tropics_Water_Vapour_Feedback_Flux_Monthly_1955', 'rb')
...
outfile = open('Water_Vapour_Feedback_Warming_1955', 'wb')
pickle.dump(alb_warming, outfile)
outfile.close()

outfile = open('Water_Vapour_Feedback_Warming_Monthly_1955', 'wb')
pickle.dump(alb_warming_mon, outfile)
outfile.close()

outfile = open('Arctic_Water_Vapour_Feedback_Warming_1955', 'wb')
pickle.dump(alb_warming_arc, outfile)
outfile.close()

outfile = open('Arctic_Water_Vapour_Feedback_Warming_Monthly_1955', 'wb')
pickle.dump(alb_warming_arc_mon, outfile)
outfile.close()

outfile = open('Tropics_Water_Vapour_Feedback_Warming_1955', 'wb')
pickle.dump(alb_warming_trop, outfile)
outfile.close()

outfile = open('Tropics_Water_Vapour_Feedback_Warming_Monthly_1955', 'wb')
pickle.dump(alb_warming_trop_mon, outfile)
outfile.close()

np.savetxt('Water_Vapour_Feedback_Warming_1955.csv', alb_warming, delimiter = ',')
np.savetxt('Water_Vapour_Feedback_Warming_Monthly_1955.csv', alb_warming_mon, delimiter = ',')

np.savetxt('Arctic_Water_Vapour_Feedback_Warming_1955.csv', alb_warming_arc, delimiter = ',')
np.savetxt('Arctic_Water_Vapour_Feedback_Warming_Monthly_1955.csv', alb_warming_arc_mon, delimiter = ',')

np.savetxt('Tropics_Water_Vapour_Feedback_Warming_1955.csv', alb_warming_trop, delimiter = ',')
np.savetxt('Tropics_Water_Vapour_Feedback_Warming_Monthly_1955.csv', alb_warming_trop_mon, delimiter = ',')
