...
ts_kernel_clearsky = ts_kernel_clearsky[:,-32:,:]
...
q_LW_kernel = q_LW_kernel[:,-32:,:,:]
q_SW_kernel = q_SW_kernel[:,-32:,:,:]
q_LW_kernel_clearsky = q_LW_kernel_clearsky[:,-32:,:,:]
q_SW_kernel_clearsky = q_SW_kernel_clearsky[:,-32:,:,:]
...
cloud_masking_of_forcing_sw = cloud_masking_of_forcing_sw[:,-32:,:]
cloud_masking_of_forcing_lw = cloud_masking_of_forcing_lw[:,-32:,:]
...
for k in range(len(data1)):
    ...
    infile.close()     
    SW_sfc_net_1 = SW_sfc_net_1[:,-32:,:]
    SW_sfc_net_2 = SW_sfc_net_2[:,-32:,:]
    ...
    if k == 0:
        ...
        infile.close()
        SW_sfc_down_1 = SW_sfc_down_1[:,-32:,:]
        SW_sfc_down_2 = SW_sfc_down_2[:,-32:,:]
    ...
    d_cre_sw = d_cre_sw[:,-32:,:]
    d_cre_lw = d_cre_lw[:,-32:,:]
...
outfile = open('Arctic_LW_Cloud_Feedback_1955', 'wb')
pickle.dump(LWc_feedback, outfile)
outfile.close()

outfile = open('Arctic_LW_Cloud_Feedback_Monthly_1955', 'wb')
pickle.dump(LWc_feedback_mon, outfile)
outfile.close()

outfile = open('Arctic_LW_Cloud_Feedback_Flux_1955', 'wb')
pickle.dump(LWc_feedback_flux, outfile)
outfile.close()

outfile = open('Arctic_LW_Cloud_Feedback_Flux_Monthly_1955', 'wb')
pickle.dump(LWc_feedback_flux_mon, outfile)
outfile.close()

outfile = open('Arctic_SW_Cloud_Feedback_1955', 'wb')
pickle.dump(SWc_feedback, outfile)
outfile.close()

outfile = open('Arctic_SW_Cloud_Feedback_Monthly_1955', 'wb')
pickle.dump(SWc_feedback_mon, outfile)
outfile.close()

outfile = open('Arctic_SW_Cloud_Feedback_Flux_1955', 'wb')
pickle.dump(SWc_feedback_flux, outfile)
outfile.close()

outfile = open('Arctic_SW_Cloud_Feedback_Flux_Monthly_1955', 'wb')
pickle.dump(SWc_feedback_flux_mon, outfile)
outfile.close()

np.savetxt('Arctic_LW_Cloud_Feedback_1955.csv', LWc_feedback, delimiter = ',')
np.savetxt('Arctic_LW_Cloud_Feedback_Monthly_1955.csv', LWc_feedback_mon, delimiter = ',')

np.savetxt('Arctic_LW_Cloud_Feedback_Flux_1955.csv', LWc_feedback_flux, delimiter = ',')
np.savetxt('Arctic_LW_Cloud_Feedback_Flux_Monthly_1955.csv', LWc_feedback_flux_mon, delimiter = ',')

np.savetxt('Arctic_SW_Cloud_Feedback_1955.csv', SWc_feedback, delimiter = ',')
np.savetxt('Arctic_SW_Cloud_Feedback_Monthly_1955.csv', SWc_feedback_mon, delimiter = ',')

np.savetxt('Arctic_SW_Cloud_Feedback_Flux_1955.csv', SWc_feedback_flux, delimiter = ',')
np.savetxt('Arctic_SW_Cloud_Feedback_Flux_Monthly_1955.csv', SWc_feedback_flux_mon, delimiter = ',')
